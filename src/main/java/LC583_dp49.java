public class LC583_dp49 {
    ...
    // 方法3:现在的思路： 我们换个角度，盯着“最终能剩下什么”。两个字符串经过删除后，最终要变成一模一样。
    // 为了让删除的次数最少，那么最终留下来的这部分重合内容，一定要越长越好！
    // 两个字符串中保留下来的、顺序一致的公共部分，完美契合“最长公共子序列LCS”的定义！LC1143
}
